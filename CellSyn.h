...
#define I_HH    0     // 1 -- HH model; 0 -- for Maps; // could be used with higher numbers for other models
...
#define N_CX2     (N_DEND + N_SOMA)
#define N_CX3     (N_DEND + N_SOMA)
#define N_CX4     (N_DEND + N_SOMA)
#define N_CX5a     (N_DEND + N_SOMA)
#define N_CX5b     (N_DEND + N_SOMA)
...
#define N_IN3     N_CX3 	
#define N_IN4     N_CX4 	
#define N_IN5a     N_CX5a 	
#define N_IN5b     N_CX5b 	
#define N_IN6     N_CX6 	
...
class StoredSpike{
  public:
  Syn * synapse;
  double timeApplySpike;
  StoredSpike(){
    synapse = NULL;
    timeApplySpike = 0;
  };
  StoredSpike(Syn * syn, double time){
    synapse = syn;
    timeApplySpike = time;
  };
};

class CompareStoredSpike
{
public:
    bool operator() (StoredSpike a, StoredSpike b)
    {
      return a.timeApplySpike > b.timeApplySpike; // according to priorityqueue documentation this inequality should be flipped but when I test this is correct
    }
};
...
class CellSyn{
 ...
 priority_queue<StoredSpike,vector<StoredSpike>,CompareStoredSpike> storedSpikes;

  double e_current, i_current, y_var;
...
class REsyn:public CellSyn{
 ...
 REsyn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
  ...
  ((RE*)base_cell)->E_l = -77; 
  ((RE*)base_cell)->G_Ca = 2.3; 
  ((RE*)base_cell)->G_kl = 0.005; //0.015; //0.005;
  this->AMPA_Rsum=0;
  this->ismap=0;
...
class TCcore: public CellSyn {
 ...
 TCcore(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
  ...
  ((TC*)base_cell)->G_A = 0;
  ((TC*)base_cell)->ginc = 2.3; // TB 1.5; //2.4; // 0.9; //2; //SWS-maxim
  //((TC*)base_cell)->E_l = -70;
  ((TC*)base_cell)->G_Ca = 2.8; //2.7; // TB 2.2; //2.7; //2.3; //2.; //SWS-maxim
  ...
  ((TC*)base_cell)->G_K = 12;
  ((TC*)base_cell)->G_h = 0.017;  
  
  ((TC*)base_cell)->G_kl = 0.0142; //0.0142;  // TB 0.03; //0.0142;  SWS-maxim 
...
class TCmatrix: public CellSyn {
 ...
 TCmatrix(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
  ...
  ((TC*)base_cell)->pc = 0.007;
  ((TC*)base_cell)->k4 = 0.001;
  ((TC*)base_cell)->INaK::Vtr = -40;
  ((TC*)base_cell)->INaK::VtrK = -28;
  ((TC*)base_cell)->G_K = 12;
  ((TC*)base_cell)->G_h = 0.017;  
...
class CXsyn: public CellSyn {
 ...
 CXsyn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
  ...
  ((CX*)base_cell)->G_kl = 0.0025;
  ((CX*)base_cell)->E_l = -68; //-67;
  ((CX*)base_cell)->G_Km = 0.01; //0.020; // TB 0.01;      //0.02;    //SWS-maxim
  ((CX*)base_cell)->G_l =  1.0e3/30000; //0.06; // TB 1.0e3/30000; //0.06;  //SWS-maxim
...
class CX2syn: public CellSyn {

 public:

 CX2syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX3syn: public CellSyn {

 public:

 CX3syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX4syn: public CellSyn {

 public:

 CX4syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX5asyn: public CellSyn {

 public:

 CX5asyn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX5bsyn: public CellSyn {

 public:

 CX5bsyn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX6syn: public CellSyn {

 public:

 CX6syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN2syn: public CellSyn {
  
 public:

 IN2syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN3syn: public CellSyn {
  
 public:

 IN3syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN4syn: public CellSyn {
  
 public:

 IN4syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN5asyn: public CellSyn {
  
 public:

 IN5asyn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN5bsyn: public CellSyn {
  
 public:

 IN5bsyn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN6syn: public CellSyn {
  
 public:

 IN6syn(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX2syn_Map: public CellSyn {

 public:
   
 CX2syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX3syn_Map: public CellSyn {

 public:
   
 CX3syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX4syn_Map: public CellSyn {

 public:
   
 CX4syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX5asyn_Map: public CellSyn {

 public:
   
 CX5asyn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX5bsyn_Map: public CellSyn {

 public:
   
 CX5bsyn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class CX6syn_Map: public CellSyn {

 public:
   
 CX6syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN2syn_Map: public CellSyn {
  
 public:

 IN2syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN3syn_Map: public CellSyn {
  
 public:

 IN3syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN4syn_Map: public CellSyn {
  
 public:

 IN4syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN5asyn_Map: public CellSyn {
  
 public:

 IN5asyn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN5bsyn_Map: public CellSyn {
  
 public:

 IN5bsyn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
...
class IN6syn_Map: public CellSyn {
  
 public:

 IN6syn_Map(int i, int j,int b_size, int t_size,Cell_Info *cell_info,int type):CellSyn(i,j,b_size,t_size,cell_info,type){
